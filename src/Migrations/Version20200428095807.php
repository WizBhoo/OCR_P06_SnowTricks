 ...
 */
final class Version20200428095807 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE snowboarder (id INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(30) NOT NULL, first_name VARCHAR(30) NOT NULL, username VARCHAR(30) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, account_token VARCHAR(255) DEFAULT NULL, account_token_at DATETIME DEFAULT NULL, account_status TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8F965D86F85E0677 (username), UNIQUE INDEX UNIQ_8F965D86E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
